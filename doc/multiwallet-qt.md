...
In order to support loading of multiple wallets in akula-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is akula.cpp.
...
Changes to akula.cpp
----------------------
akula.cpp is the entry point into akula-qt, and as such, will require some minor modifications to provide hooks for
