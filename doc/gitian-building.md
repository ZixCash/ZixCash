...
*Setup instructions for a gitian build of Akula using a Debian VM or physical system.*
...
Clone the git repositories for akula and gitian and then checkout the akula version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/ALPHANODE/Akula.git
cd akula
...
Follow the instructions in [doc/release-process.md](release-process.md) in the akula repository
...
To build Akula (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the akula repository.
...
```bash
    ...
    From https://github.com/ALPHANODE/Akula
...
For example:
```bash
URL=https://github.com/ALPHANODE/Akula
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/akula-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/akula-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/akula-build.assert
```
...
[akula/gitian.sigs](https://github.com/akula-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
