...
This mechanism has been integrated into Bitcore-Node-Akula which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/akulacoin/insight-api-akula#web-socket-api](https://github.com/akulacoin/insight-api-akula#web-socket-api) 
* API: [https://github.com/akulacoin/insight-api-akula#instantsend-transactions](https://github.com/akulacoin/insight-api-akula#instantsend-transactions) 
...
By default, the Akula Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Akula Core daemon:
