...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AkulaNetwork") type = AkulaNetwork;
    if(strType == "AkulaNetworkVariable") type = AkulaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AkulaNetwork) s = "AkulaNetwork";
    if(type == AkulaNetworkVariable) s = "AkulaNetworkVariable";
