 ...
 *
 *   // network
 *   CAkulaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.akula.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAkulaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AkulaNetwork
// //   -- signature requirements : Key1(User)
// class CAkulaNetworkVariable : public CGovernanceObject
// {
// private:
