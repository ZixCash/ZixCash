...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AKL features */
        {"akula", "masternode", &masternode, true, true, false},
        {"akula", "masternodelist", &masternodelist, true, true, false},
        {"akula", "mnbudget", &mnbudget, true, true, false},
        {"akula", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"akula", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"akula", "mnsync", &mnsync, true, true, false},
        {"akula", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"akula", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use akulad, or the -server option to akula-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> akula-cli " + methodname + " " + args + "\n";
}
