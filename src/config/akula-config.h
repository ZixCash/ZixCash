/* src/config/akula-config.h.  Generated from akula-config.h.in by configure.  */
/* src/config/akula-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://akula.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Akula Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Akula Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "akula"
