    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Akula Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Akula Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  akula-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Akula in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AKL, 0.1 AKL, 1 AKL and 10 AKL -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Akula Core is shutting down...") + "<br /><br />" +
