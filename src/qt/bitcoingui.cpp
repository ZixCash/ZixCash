    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Akula Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Akula address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and akula: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Akula Core"), this);
    aboutAction->setStatusTip(tr("Show information about Akula Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Akula Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Akula addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Akula addresses"));
    ...
    openAction->setStatusTip(tr("Open a akula: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Akula Core help message to get a list with possible Akula Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Akula Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Akula network", "", count));
}
...
{
    QString strTitle = tr("Akula Core"); // default title
