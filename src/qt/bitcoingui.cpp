                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Akula-Coin") + " - ";
#ifdef ENABLE_WALLET
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Akula Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Akula"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Akula Core help message to get a list with possible Akula command-line options"));
