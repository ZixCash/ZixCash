    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AKL-light"), QVariant("light"));
    ui->theme->addItem(QString("AKL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AKL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AKL-traditional"), QVariant("trad"));
