...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "akula.conf"));
    ...
    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty akula.conf if it does not exist
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "akulad.pid"));
