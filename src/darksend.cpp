...
{
    if(fLiteMode) return; // ignore all Akula related functionality
...
/*
    ...
    allow endless transaction that would bloat Akula and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("akula-privatesend");
