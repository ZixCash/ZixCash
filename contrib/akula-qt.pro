...
RESOURCES += src/qt/akula.qrc src/qt/akula_locale.qrc

TRANSLATIONS += src/qt/locale/akula_bg.ts \
                src/qt/locale/akula_de.ts \
                src/qt/locale/akula_en.ts \
                src/qt/locale/akula_es.ts \
                src/qt/locale/akula_fi.ts \
                src/qt/locale/akula_fr.ts \
                src/qt/locale/akula_it.ts \
                src/qt/locale/akula_ja.ts \
                src/qt/locale/akula_pl.ts \
                src/qt/locale/akula_pt.ts \
                src/qt/locale/akula_ru.ts \
                src/qt/locale/akula_sk.ts \
                src/qt/locale/akula_sv.ts \
                src/qt/locale/akula_vi.ts \
                src/qt/locale/akula_zh_CN.ts \
                src/qt/locale/akula_zh_TW.ts
