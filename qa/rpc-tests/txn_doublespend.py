...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 AKL:
        ...
        # First: use raw transaction API to send 12400 AKL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 AKL coin each
        ...
        # Node0's balance should be starting balance, plus 500AKL for another
        ...
        # Node0's total balance should be starting balance, plus 1000AKL for
